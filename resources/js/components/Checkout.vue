    ...
    <div>
        <div class="container">
                ...
                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                    <div class="box">
                        ...
                        <div
                            ...
                            :key="item.id"
                        >
                            <div class="plan-data" v-if="item.id != null">
                                <input
                                    id="question1"
                                    name="question"
                                    type="radio"
            ...
            <div class="row">
                ...
                >
                    Created for
                    <a href="https://goo.gl/XwHgxp" target="_blank"
                        >easetemplate</a
                    >
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getUserAddress(){
            if(this.firstName != '' && this.address != '' && this.cardNumber && this.cvvNumber){
                //process payment
            }
            else{
                this.$toastr.e("Incorrect user information");
            }
        }
    },
    created() {
